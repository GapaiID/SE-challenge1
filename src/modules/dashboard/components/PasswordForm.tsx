                    ...
                    <div className="field">
                        ...
                        <div className="control">
                            <input
                                ...
                                className={[
                                    'input',
                                    errors.oldPassword && touched.oldPassword && errors.oldPassword ? 'is-danger' : '',
                                ].join(' ')}
                                type="password"
                                disabled={isLoading}
                    ...
                    <div className="field">
                        ...
                        <div className="control">
                            <input
                                ...
                                className={[
                                    'input',
                                    errors.newPassword && touched.newPassword && errors.newPassword ? 'is-danger' : '',
                                ].join(' ')}
                                type="password"
                                disabled={isLoading}
                                placeholder="Enter your Name"
                    ...
                    <div className="field">
                        ...
                        <div className="control">
                            <input
                                ...
                                className={[
                                    'input',
                                    errors.confirmPassword && touched.confirmPassword && errors.confirmPassword ? 'is-danger' : '',
                                ].join(' ')}
                                type="password"
                                disabled={isLoading}
                                placeholder="Enter your Name"
